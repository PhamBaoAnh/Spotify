...
with open(r'C:\Users\msi\Desktop\Spotify\kafka\test_connection\data\rides.csv', mode='r', encoding='utf-8') as file:
    ...
    for row in csvreader:
        ...
        producer.send('yellow_taxi_ride_json', value=value, key=key)  # Sửa tên topic
